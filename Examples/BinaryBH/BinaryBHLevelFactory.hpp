...
{
public:
  BinaryBHLevelFactory(GRAMR * a_amr, SimulationParameters& a_sim_params, ProfilingInfo * profilingInfo=nullptr);
...
{
    BinaryBHLevel* binary_bh_level_ptr = new BinaryBHLevel (m_amr,m_p, m_p.verbosity, m_profilingInfo);
